...
# If you have multiple preferred slots in a day, list them according to order of preference
...
USER_BOOKING_LIST = [
    ...
    [
        DateTimeRange('1900-01-01T16:00:00', '1900-01-01T17:00:00')
    ],
    [
        DateTimeRange('1900-01-01T09:00:00', '1900-01-01T11:00:00')
    ],
    [
        DateTimeRange('1900-01-01T10:15:00', '1900-01-01T11:00:00')
    ],
    [
        # DateTimeRange('1900-01-01T15:15:00', '1900-01-01T16:00:00'),
        # DateTimeRange('1900-01-01T11:15:00', '1900-01-01T12:00:00'),
        # DateTimeRange('1900-01-01T09:00:00', '1900-01-01T10:00:00')
        NO_BOOKING
    ],
    [
        DateTimeRange('1900-01-01T15:45:00', '1900-01-01T17:45:00')
    ],
    [
        NO_BOOKING
    ],
...
PASSWORD = ''
# As per the booking form, this will be your UoB username by deault.
BOOKING_DESCRIPTION = USERNAME

# The minimum and maximum length you would like your bookings to be.
MIN_BOOKING_LENGTH = timedelta(hours=1, minutes=0)
